package edu.seminars.threads.locks;
...
public class ExceptionalStorageWithPeriodicDump {
    ...
    public ExceptionalStorageWithPeriodicDump(Consumer<Map<String, String>> dumpStorage) {
